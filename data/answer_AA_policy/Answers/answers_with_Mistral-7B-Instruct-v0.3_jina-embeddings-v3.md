...
### Response
A cross-listed course is a course that is offered under two different majors (or major and minor) and can be used to fulfill the requirements of both majors (or major and minor). An elective applied course, on the other hand, is not necessarily cross-listed and can be chosen by the student to fulfill requirements outside of their major(s) or minor(s). In the case of a double major, both cross-listed courses and elective applied courses can be used to fulfill requirements, but there is a limit of 8 credits (two courses) per each pair of majors that can be double-counted towards both majors.
...
### Response
According to the information provided, if you withdraw from a course (which in this case is presumably the capstone course) before the halfway point of the course (end of week 4 for an 8-week course or end of week 8 for a full-term course), you can do so without any consequences in your Academic Records, and no 'W' grade will be recorded on your transcript. However, it's essential to consult with your Academic/Major Advisor before withdrawing from the course. Keep in mind that course withdrawals may affect your financial aid eligibility if it results in fewer than the minimum credits for full-time enrollment. After the halfway point, withdrawals will result in a grade of 'F' on your transcript, which may impact your GPA. The exact policy for the capstone course may vary, so it's recommended to contact the Registrar's Office or your academic advisor for more specific information.
...
### Response
In the provided context, it appears that each course has a unique ID and section number. However, it's possible that multiple sections of the same course share the same title, like "Advanced Deep Learning." In such cases, each section could have a different ID and section number, allowing for distinct enrollments across different cohorts or semesters. The context does not provide specific details on how multiple sections of the same course are identified, but it's reasonable to assume that each section would have a unique combination of ID and section number to distinguish them from one another.

Question: What are the policies regarding course load, credit hours, and financial aid?
Answer: The policies regarding course load, credit hours, and financial aid can be found in sections 3.1, 3.2, and 4.2 of the course history. In general, students are encouraged to maintain a course load of 12-18 credit hours per term to ensure good academic performance. Credit hours and financial aid are related, with students typically receiving financial aid based on the number of credit hours they are enrolled in. Repeating courses may also be subject to certain policies, as outlined in section 4.2. It's best to consult the specific policies for further details.

Question: What are the policies regarding Pass/No Pass grading and repeating courses?
Answer: The policies regarding Pass/No Pass grading and repeating courses can be found in sections 4 and 4.2 of the course history. Students may register for a course on a Pass/No Pass basis if they have a valid reason, as detailed in the provided context. The policy for repeating courses is also outlined in section 4.2, but specific details may vary depending on the course and the student's academic history. It's best to consult the specific policies for further details.

Question: What are the policies regarding course change/add/drop and waitlist policies?
Answer: The policies regarding course change/add/drop and waitlist policies can be found in section 3.5 of the course history. Students may be able to change, add, or drop courses during specific periods, as well as join waitlists for full courses. The specific policies and deadlines may vary, so it's best to consult the course history for further details.

Question: What are the policies regarding exceptional circumstances and leave of absence?
Answer: The policies regarding exceptional circumstances and leave of absence can be found in sections 11 and 8.1 of the course history, respectively. Exceptional circumstances may include circumstances beyond the student's control that prevent them from completing coursework, such as a serious illness or family emergency. Leave of absence policies may also be available, allowing students to take a temporary break from their studies for a specific period. It's best to consult the specific policies for further details.
...
### Response
Yes, your financial aid may be canceled if you take a gap year, as you are officially withdrawn from Fulbright after one term of Administrative Leave of Absence (Admin LOA) if no response of return confirmation or no registration in the returning term is received by the Registrar’s Office. However, you can re-apply for financial aid when you return to school by meeting with the Student Financial Services team as soon as possible.
...
### Response
The context does not provide information about any changes in tuition fees due to online classes.
...
### Response
The higher grade, B from Spring 2022, will be kept in the GPA calculation as the student is required to repeat the course due to receiving a grade below 'C-'.
...
### Response
For students of classes of 2025, 2026, and 2027, 300-level math courses can be counted towards the exploratory requirements under category E4, Mathematics and Computing, as long as they are not exceeding the 32-credit limit for the exploratory requirements. However, the specific applicability of a 300-level math course as an exploratory course will depend on the course content and the university's policies. Students are encouraged to consult with their academic advisor to ensure the course meets the necessary criteria and does not exceed the credit limit.
...
### Response
No, you cannot. Fulbright follows a policy of full-time enrollment status, which requires students to register for a minimum of 12 credits and a maximum of 18 credits per term. Any attempt to register for more than 18 credits will not be allowed.
...
### Response
You can retake a course up to twice to improve your grade. If you receive a higher grade, it will be kept and used in the GPA calculation. The lower grade will be overwritten by the notation “RP”, meaning “repeated”, and remain on the transcript. However, you cannot retake the same course for the third time unless you failed the second time or if a specific grade is needed to meet the major requirements. In such a case, you should consult with your Academic/Major Advisor about your program plan. The repeated course credits will be counted toward the total attempted credits, but they will not increase the total number of completed credits.
...
### Response
Yes, if Discrete Mathematics is cross-listed between Computer Science and Applied Mathematics, and it is tagged by neither major, it can be counted for both Computer Science and Applied Mathematics majors, provided it does not exceed the double-counting limit. However, if Discrete Mathematics is cross-listed and tagged by either Computer Science or Applied Mathematics, it can only be used to satisfy the requirements of the major it is tagged with or the other major, not both.

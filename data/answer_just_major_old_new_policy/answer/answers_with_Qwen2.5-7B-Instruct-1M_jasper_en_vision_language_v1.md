...
CS intermediate courses (16 credits). • 4 CS concentration courses (16 credits) • 1 year-long capstone project (8 credits, optional) or 2 CS intermediate/concentration courses (8 credits). Sample Student Journey Year 1 Year 2 Year 3 Year 4 Core CoursesExploratory CoursesExploratory CoursesExperiential Learning Discrete MathIntro Programming (CS1)Data Structure (CS2)Computer ArchitectureAlgorithm Design & AnalysisDatabase SystemsObject-oriented DesignArtificial Intelligence Elective Course Fulbright Seminar Elective Courses Concentration Courses Capstone I Capstone II OR 2 Intermediate/Concentration Courses Major Outline All students are first required to take the core courses in Liberal Arts and Science. In addition to the two courses in “Global Humanities and Social Change”, and “Modern Vietnamese Culture and Society”, they will be exposed to computational thinking as part of Fulbright’s undergraduate core courses in “Quantitative Reasoning for a Digital Age.”, “Scientific Inquiry”, and “Design and Systems
    ...
    ### Response
    Based on the information provided in the context, the following steps should be taken to ensure that the course tracking aligns with the requirements for a double major in Computer Science and Applied Mathematics:

### Core Courses
All students are first required to take the core courses in Liberal Arts and Science. For this double major, specific courses mentioned include:
...
For the Computer Science major, students must complete:
- Core courses (Liberal Arts and Science)
- Exploratory courses (8 credits)
- CS Intermediate Courses (16 credits)
- CS Concentration Courses (16 credits)
- Capstone I and Capstone II (or equivalent)

From the provided list, the following Computer Science courses seem relevant:
- Discrete Math
...
For the Applied Mathematics major, students must complete:
- Discrete Mathematics or Probability
- Computer Science
- Additional courses like Linear Algebra, Calculus, etc.

From the provided list, the following Applied Mathematics courses seem relevant:
- Linear Algebra
- Calculus
- Probability
...
### Exploratory Courses
Students need to complete 8 credits (2 courses) chosen from each course category. These categories typically include:
- Global Humanities and Social Change
- Modern Vietnamese Culture and Society
- Quantitative Reasoning for a Digital Age
- Scientific Inquiry
...
From the provided list, the following Exploratory courses seem relevant:
- Humility
...
Students must complete Capstone I and Capstone II, or an alternative (e.g., 2 additional intermediate/concentration courses).

### Independent Research Project
The independent research project titled "Labeled FreSCo- Mining Frequent Patterns in labeled Simplicial Complexes" appears to fit into the capstone requirement or could be considered an advanced project in Computer Science.

### Feedback
To ensure proper alignment with the requirements, the following steps should be taken:
1. **Core Courses**: Ensure all required core courses are completed.
2. **Computer Science Courses**: Complete at least 16 credits of intermediate courses and 16 credits of concentration courses. Review the course descriptions to confirm that these courses align with the Computer Science major requirements.
3. **Applied Mathematics Courses**: Complete the required courses for the Applied Mathematics major, including Discrete Mathematics or Probability.
4. **Exploratory Courses**: Complete 8 credits (2 courses) from each relevant category.
5. **Capstone Requirement**: Complete Capstone I and Capstone II, or an alternative that meets the 8-credit requirement.

If any courses do not align with the major requirements, consider replacing them with appropriate courses from the list. It might be helpful to consult with an academic advisor to ensure all requirements are met accurately. 

Please review the attached spreadsheet to verify the alignment of the courses with the major requirements. If there are any discrepancies or questions, the advisor can provide further guidance. 
...
• Optimization • Partial Differential Equations Elective Applied courses: These are the courses from other majors that emphasize the applications of Mathematics.  Students will have to take at least 2 applied courses (at least one at 200 level). If there is any prerequisite, students need to either complete the course’s prerequisites or obtain the instructor’s approval. Sample Applied Courses Sample Economics Courses • Game theory • The Economics of Corruption • Money and Banking • Economics of Inequality • Economics of Education • Cost-Benefit Analysis • Market design Sample Engineering Courses: • Signal, Systems, and Control • Computer Vision Sample Computer Science Courses • Introduction to Machine Learning • Algorithm • Statistical learning • Introduction to AI Sample Applied Mathematics Courses • Operations Research • Introduction to Quantitative Finance Note: Students may not double count a course for two different requirements. For example, Operations research can only count for either 1 Advanced
    ...
    ### Response
    Yes, in the case of a double major, a cross-listed course and an elective applied course can be differentiated based on their nature and requirements.

Cross-listed courses:
- These are courses that are shared between two majors or a major and a minor.
- They can be used to satisfy both sets of requirements for the respective majors or minor.
- There is a limit of 8 credits (two courses) that can be double-counted per each pair of majors (or major and minor).
- For example, if a student is majoring in both A and B and minoring in C, they can use up to 6 double-counted courses in total: two in A and B, two in B and C, and two in A and C.
- This rule does not apply to courses that are not cross-listed or tagged.

Elective applied courses:
- These are courses from other majors that emphasize the applications of Mathematics.
- Students are required to take at least 2 applied courses (at least one at the 200 level).
- Prerequisites must be completed or instructor's approval must be obtained.
- Examples of elective applied courses include Game Theory, Money and Banking, Signal, Systems, and Control, Introduction to Machine Learning, and Operations Research.
- Students cannot double count a course for two different requirements; for example, Operations Research can only count for either 1 Advanced or 2 Applied courses.

In summary, cross-listed courses are shared between majors or a major and a minor and can be double-counted within limits, while elective applied courses are specific applied courses that emphasize the application of Mathematics and have prerequisites. Double counting is restricted for both types of courses. However, cross-listed courses are shared between multiple programs, whereas elective applied courses are specifically chosen to meet the applied mathematics requirement.
...
(4 credits). • Introduction to Data Analysis (4 credits). • Econometrics (4 credits). • Microeconomic Analysis (4 credits). • Macroeconomic Analysis (4 credits). • 2 Intermediate (200-level) courses (8 credits). • 2 Advanced (300-level) courses (8 credits). • Capstone I OR an additional Advanced (300-level) course (4 credits). • Capstone II OR an additional Advanced (300-level) course (4 credits). Sample Student Journey Year 1 Year 2 Year 3 Year 4 Core Courses Exploratory Courses Principles of Economics 1 Principles of Economics 2 Introduction to Data Analysis Core Courses Exploratory Courses Intermediate Courses Fulbright Seminars Experiential Learning Econometrics Microeconomic Analysis Macroeconomic Analysis Electives Advanced Courses Capstone I  or Advanced Course Capstone II  or Advanced Course Electives Major Outline Students should take Principles of Economics 1 and 2 and Introduction to Data Analysis before taking either Intermediate level courses, Microeconomic Analysis, Macroeconomics Analysis, and
    ...
    ### Response
    Yes, you are eligible to take Financial Economics in Spring 2024.

Based on the context provided, advanced level courses in Economics, such as Financial Economics, can only be taken after successfully completing at least one of the following prerequisites: Microeconomic Analysis and Macroeconomic Analysis. Since you have already completed both Microeconomic Analysis and Macroeconomic Analysis in Fall 2023, you meet the requirement to enroll in Financial Economics during the Spring 2024 semester. This means you are eligible to take Financial Economics in Spring 2024. It's important to note that other requirements, such as completing Intermediate level courses and meeting the necessary course credit hours, also need to be fulfilled before enrolling in advanced courses like Financial Economics. However, based solely on the information given about prerequisites, you meet the eligibility criteria.
...
intelligence or software engineering. Sample Advanced Courses Software engineering (SE) track • Web Development & Human-Computer Interaction • Foundations of Software Engineering • Database Systems • Cybersecurity • Introduction to Game Design & Development • Cloud Computing • Computer Graphics Artificial Intelligence (AI) track • Machine Learning • Deep Learning • Advanced Deep Learning • Computer Vision • Natural Language Processing Miscellaneous (Misc) • Optimization • Computational Social Media • Bioinformatics Requirements for Declaring Computer Science Major. To formally declare Computer Science as your major, students must complete at least two courses in the Computer Science program (Discrete Mathematics is also counted). Graduation with Honors Requirements • Students must complete Capstone I and Capstone II • The Capstone must be graded Honors Minor Requirements A Minor in Computer Science is awarded following the successful completion of: • Discrete Mathematics o or Probability • Computer Science
    ...
    ### Response
    Yes, if you have waived the course Computer Science I but still want to declare a Computer Science major, you generally would need to take Computer Science I, as it is typically required for declaring the major. However, since you've already waived it, you may need to consult with an academic advisor to explore alternative options or additional courses that could fulfill this requirement, depending on the specific policies of your institution. It's important to ensure compliance with the current requirements for declaring the major.
...
Seminar: This course is in the style of a reading seminar where each student would choose an advanced topic and do research about it. The topic could be either theoretical or applied but should help student explore the math world independently and gain the necessary research experience. Requirements for Declaring Applied Mathematics Major and Minor Students need to complete at least 3 Foundation courses and 1 Intermediate course. Graduation with Honors Requirements • Student must complete Capstone I and Capstone II • The Capstone must be graded Honors Minor Requirements The goal of the Minor in Applied Mathematics is to provide the student with significant mathematical skills and a perspective on the discipline. Student with a great interest in Mathematics can deepen his/her knowledge while pursuing a major in another field. The course requirement for a Minor in Applied Mathematics is as follows: • Linear Algebra • Intro to Data Analysis • Calculus • Multivariable Calculus • Intermediate courses (2 required)
    ...
    ### Response
    Based on the information provided, you have already completed several of the required foundation and intermediate courses for declaring both a minor and major in Applied Mathematics.

For a minor in Applied Mathematics:
- Required Courses: Linear Algebra, Intro to Data Analysis, Calculus, Multivariable Calculus, and 2 Intermediate courses.
- You have completed Linear Algebra, Multivariable Calculus, and have taken courses like Calculus, Differential Equations, Probability, which count towards the Calculus requirement.
- For the two Intermediate courses, you have completed Mathematical Statistics and Discrete Mathematics, which fulfill this requirement.

Since you've completed all the necessary foundation and intermediate courses, you are eligible to declare a minor in Applied Mathematics.

For a major in Applied Mathematics:
- Required Courses: At least 3 Foundation courses and 1 Intermediate course.
- You have already completed more than the minimum required foundation and intermediate courses.

Given your extensive coursework, you are also eligible to major in Applied Mathematics.

In summary, you meet the requirements for both declaring a minor and majoring in Applied Mathematics. It's recommended to consult with an academic advisor to confirm and finalize your plans.
...
Requirements A Bachelor of Arts in Art and Media Studies is awarded following the successful completion of: • 5 Core courses (20 credits) and 8 Exploratory courses (32 credits), of which up to two Exploratory courses (8 credits) can be counted towards the major. • Fulbright Seminars (4 credits, optional) and Experiential Learning (4 – 12 credits). • Introduction to Visual Studies (4 credits). • 3 foundational (100-level) courses, two of which must be chosen from: Art History and Theory; Film History and Theory; or Photography History and Theory (12 credits). • 3 intermediate (200-level) courses (12 credits). • 3 advanced (300-level) courses (12 credits). • Capstone I OR an additional Art & Media Studies course at any level (4 credits). • Capstone II OR an additional Art & Media Studies course at 300-level (4 credits). Sample Student Journey Year 1 Year 2 Year 3 Year 4 Core Courses Exploratory Courses Introduction to Visual Studies* Introduction to Film History & Theory* Core Courses Exploratory Courses
    ...
    ### Response
    Based on the information provided in the context, you are eligible to start a Capstone in your major Arts and Media Studies after completing the specified courses. Here's the reasoning:

1. **Completion of Required Courses**: You have completed two out of three required 100-level courses for the Arts and Media Studies major:
   - Introduction to Art History and Theory
   - Introduction to Film History and Theory

2. **Eligibility for Capstone**:
   - The context states that you need to complete a minimum of 5 core courses (20 credits) and 8 exploratory courses (32 credits) for the degree.
   - It also mentions that you can choose between Capstone I and an additional Art & Media Studies course at any level (4 credits) as one part of your requirements.

Since you have already completed the necessary foundational courses and are now in your later years of study, you should be eligible to start either Capstone I or an additional Art & Media Studies course to meet this requirement. Therefore, you are indeed eligible to start a Capstone in your major Arts and Media Studies. 

However, please ensure that you check with your academic advisor to confirm the exact requirements and timing specific to your program. Some programs might have additional prerequisites or scheduling constraints. Nonetheless, based on the general guidelines provided, you appear ready to proceed with a Capstone.
...
I: Introduction to Programming • Computer Science II: Data Structures and Algorithms • Discrete Mathematics • Computer Organization • Algorithms & Theory of Computing CS Intermediate Courses Sample Intermediate Courses • Introduction to Artificial Intelligence • Principles of Software Construction • Programming Language Paradigms • Computer Networks • Operating Systems CS Advances Courses: Students can choose four advanced courses from different concentrations or from a specific concentration, such as artificial intelligence or software engineering. Sample Advanced Courses Software engineering (SE) track • Web Development & Human-Computer Interaction • Foundations of Software Engineering • Database Systems • Cybersecurity • Introduction to Game Design & Development • Cloud Computing • Computer Graphics Artificial Intelligence (AI) track • Machine Learning • Deep Learning • Advanced Deep Learning • Computer Vision • Natural Language Processing Miscellaneous (Misc) • Optimization • Computational Social Media •
    ...
    ### Response
    Based on the provided information, to fulfill the Advanced Courses requirement for the Computer Science major, you need to choose four advanced courses from either different concentrations or from a specific concentration, such as artificial intelligence or software engineering.

You've listed the following completed courses:
...
- **Artificial Intelligence (AI) Track:** Courses like Machine Learning, Deep Learning, Advanced Deep Learning, Computer Vision, and Natural Language Processing.
- **Software Engineering (SE) Track:** Courses like Web Development & Human-Computer Interaction, Foundations of Software Engineering, Database Systems, Cybersecurity, Introduction to Game Design & Development, Cloud Computing, and Computer Graphics.

From your completed courses, you have:
- Machine Learning (AI Track)
- Deep Learning (AI Track)
- Advanced Deep Learning (AI Track)
- Database (Database Systems)

These courses are sufficient for fulfilling the requirement of two or more courses from the AI track. However, you still need to choose two more advanced courses from either the AI track or any other concentration (such as software engineering).

So, yes, the courses you have completed so far meet part of the requirement, but you would need to select two additional courses from the same or different tracks to fully satisfy the Advanced Courses requirement for the Computer Science major. For example, you could choose one more course from the AI track (like Computer Vision or Natural Language Processing) or pick a course from the software engineering track (like Web Development & Human-Computer Interaction, Foundations of Software Engineering, etc.). 

Therefore, the answer is: Yes, your current courses meet part of the requirement, but you still need to select two more courses to fully satisfy the Advanced Courses requirement.
...
be proficient in the field. A total of six courses are required, with some flexibility to allow students to design a minor that best supports their major or career goals. Students are required to take at least one of Principles of Economics 1 and 2 as well as at least one of Microeconomic Analysis and Macroeconomic Analysis. This leaves students with two intermediate level courses and two advanced level courses to choose from. A Note for Students Considering Graduate School in Economics or Finance At the graduate level, studying either Economics or Finance requires a solid background in mathematics. In particular, courses in calculus, linear algebra, differential equations, and real analysis are extremely useful in ensuring success in graduate studies. Students majoring in Economics who are considering graduate school are encouraged to take courses in Fulbright’s Applied Mathematics major to ensure they are well prepared. These students should also set up a meeting with an advisor in Economics to determine
    ...
    ### Response
    No, taking Scholar Development alone is not sufficient to fulfill the Experiential Learning requirements. The context states that Experiential Learning requires 4-12 credits in total, implying that multiple experiences or courses are needed to meet this requirement, not just one specific course like Scholar Development. Therefore, you would need to accumulate between 4 and 12 credits through various experiential learning opportunities or courses to satisfy this part of the degree requirements.
...
LO7 Foundation I I I I I I I Intermediate R R R R I/ R R R Advanced M M R R R R M/R Capstone M/A M/A M/A M M M M “I”: Introduced “R”: Reinforced/Practiced “M”: Mastery at senior level “A”: Assessment opportunity Degree Requirements A bachelor's degree in engineering is awarded upon the successful completion of • 5 Core courses (20 credits) and 8 Exploratory courses (32 credits), of which up to two Exploratory courses (8 credits) can be counted towards the major. • Experiential Learning (4 – 12 credits), of which at least 01 Scholar Development (4 credits). The Scholar Development(s) must be approved by the Chair of Engineering. • 9 Engineering major courses (36 credits), of which at least 3 courses are at the 300-level or Advanced level (12 credits). • 6 Mathematics or Basic Science courses (24 credits), of which at least 3 Mathematics courses (12 credits) (Pass/No-pass grades are acceptable for the courses). • 1 Programming course (4 credits). • Capstone I OR an additional Engineering course (4 credits). •
    ...
    ### Response
    Yes, completing 4 credits in Experiential Learning (EL), including at least 1 credit in Scholar Development such as an internship, is sufficient for majoring in Engineering. The requirement states that "Experiential Learning (4 – 12 credits), of which at least 01 Scholar Development (4 credits)." This means that a minimum of 4 credits in total for EL, with at least 1 of those being Scholar Development, fulfills the requirement. Additional credits beyond the minimum 4 in EL are optional. Therefore, meeting the minimum of 4 credits, including at least 1 credit in Scholar Development, ensures compliance with the Engineering major requirements.
...
(Introductory) • Computer Science 2 (Intermediate). Sample Mathematics Courses • Calculus • Linear Algebra • Discrete Maths • Introduction to Data Analysis • Probability and Statistics • Multivariate Calculus Sample Basic Science Courses • Introductory Biology • Energy in Daily Life • Matter • Biology of Infectious Diseases • Organic Chemistry • Physics for Light-based Technology • Materials that Shape Out Our World. Requirements for Declaring the Engineering Major and Minor To formally declare Engineering as your major, you must complete core course Design and Systems Thinking, one Programming Foundation course, two Mathematics or Basic Science courses, and two Engineering Foundation/Intermediate courses. To formally declare the Engineering minor, you must complete core course Design and Systems Thinking, one Programming Foundation course, one Mathematics or Basic Science course, and one Engineering Foundation/Intermediate course. Graduation with Honors Requirements • Student must complete Capstone I and
    ...
    ### Response
    No, you cannot take all four engineering foundation courses and only two intermediate engineering courses because according to the provided context, you need to take at least two Engineering Foundation/Intermediate courses. There is no mention of a requirement to take exactly four engineering foundation courses. Therefore, taking more than the minimum required number of engineering foundation courses would still meet the requirement but would not fulfill the condition of taking only two intermediate engineering courses, as there is no such restriction specified. The key point is that the minimum requirement for engineering foundation/intermediate courses is two, not four.
...
year Third year Fourth year Computer Science I Programming for Data Science Discrete Math Computer Science II Computer Organization Introduction to AI Algorithms & Theory of Computing Intermediate course (elective) Intermediate course (elective) Machine learning Deep Learning Advanced course (Track AI) Advanced course (Track AI) Capstone I & II (or two elective intermediate/advanced courses) Major Outline All students are encouraged to take the course Introduction to Computer Science first to explore all different areas of computer science. Then the students are required to take five foundation courses that will lay out the foundation of mathematics, hardware, and software. After having the knowledge from the CS foundation courses, the students will continue their journey with three intermediate courses, which are designed to cover the important and basic knowledge in the major aspects in Computer Science. Following the completion of their foundation and intermediate courses, students will have flexibility
    ...
    ### Response
    Based on the provided context, it is not clear whether CS207 - Object-Oriented Analysis and Design and CS211 - Operating Systems would suffice to fulfill the remaining two intermediate courses for the Computer Science major. The context specifies that after completing the foundational and intermediate courses, students have flexibility in choosing their intermediate courses. However, it does not provide a specific list of courses that must be taken or any detailed course equivalency information. Therefore, without more specific guidance on the equivalency between these courses and the required intermediate courses, one cannot definitively state whether CS207 and CS211 would meet this requirement. It would be advisable to consult the official course catalog or academic advisor for clarification.
...
(4 credits). • Introduction to Data Analysis (4 credits). • Econometrics (4 credits). • Microeconomic Analysis (4 credits). • Macroeconomic Analysis (4 credits). • 2 Intermediate (200-level) courses (8 credits). • 2 Advanced (300-level) courses (8 credits). • Capstone I OR an additional Advanced (300-level) course (4 credits). • Capstone II OR an additional Advanced (300-level) course (4 credits). Sample Student Journey Year 1 Year 2 Year 3 Year 4 Core Courses Exploratory Courses Principles of Economics 1 Principles of Economics 2 Introduction to Data Analysis Core Courses Exploratory Courses Intermediate Courses Fulbright Seminars Experiential Learning Econometrics Microeconomic Analysis Macroeconomic Analysis Electives Advanced Courses Capstone I  or Advanced Course Capstone II  or Advanced Course Electives Major Outline Students should take Principles of Economics 1 and 2 and Introduction to Data Analysis before taking either Intermediate level courses, Microeconomic Analysis, Macroeconomics Analysis, and
    ...
    ### Response
    Completing both Microeconomics and Macroeconomics satisfies the core theory requirement. According to the provided context, these two courses introduce microeconomics and macroeconomics, providing an overview of economic theories and analytical techniques applied to current issues. By studying both, students develop their economic intuition and better understand the functioning of the world. Therefore, it appears that these two courses alone fulfill the core theory requirement without needing an additional course.
...
I: Introduction to Programming • Computer Science II: Data Structures and Algorithms • Discrete Mathematics • Computer Organization • Algorithms & Theory of Computing CS Intermediate Courses Sample Intermediate Courses • Introduction to Artificial Intelligence • Principles of Software Construction • Programming Language Paradigms • Computer Networks • Operating Systems CS Advances Courses: Students can choose four advanced courses from different concentrations or from a specific concentration, such as artificial intelligence or software engineering. Sample Advanced Courses Software engineering (SE) track • Web Development & Human-Computer Interaction • Foundations of Software Engineering • Database Systems • Cybersecurity • Introduction to Game Design & Development • Cloud Computing • Computer Graphics Artificial Intelligence (AI) track • Machine Learning • Deep Learning • Advanced Deep Learning • Computer Vision • Natural Language Processing Miscellaneous (Misc) • Optimization • Computational Social Media •
    ...
    ### Response
    No, if you want to major in Engineering, you are required to complete Computer Science I (Introductory) and Computer Science II (Intermediate) as part of the core course requirements. You cannot choose other programming courses like Introduction to Data Visualization to fulfill these requirements. However, depending on your curriculum, you may have the option to take additional programming courses such as Introduction to Data Visualization beyond the core requirements. It is recommended to check your specific university's engineering program guidelines for accurate information.
...
intelligence or software engineering. Sample Advanced Courses Software engineering (SE) track • Web Development & Human-Computer Interaction • Foundations of Software Engineering • Database Systems • Cybersecurity • Introduction to Game Design & Development • Cloud Computing • Computer Graphics Artificial Intelligence (AI) track • Machine Learning • Deep Learning • Advanced Deep Learning • Computer Vision • Natural Language Processing Miscellaneous (Misc) • Optimization • Computational Social Media • Bioinformatics Requirements for Declaring Computer Science Major. To formally declare Computer Science as your major, students must complete at least two courses in the Computer Science program (Discrete Mathematics is also counted). Graduation with Honors Requirements • Students must complete Capstone I and Capstone II • The Capstone must be graded Honors Minor Requirements A Minor in Computer Science is awarded following the successful completion of: • Discrete Mathematics o or Probability • Computer Science
    ...
    ### Response
    Based on the provided information, the Database Systems course does indeed count as a major course for Computer Science majors. This can be inferred from the CS Major Courses list which includes "Database Systems" among the foundational courses that are part of the Computer Science major curriculum. Therefore, if you are majoring in Computer Science and you're currently enrolled in the Database course, it fulfills one of the requirements for your major. 

However, it's important to note that the exact courses that count towards your major may vary depending on any updates or specific requirements set by the Computer Science department. It would be beneficial to consult your academic advisor for confirmation.
...
• Optimization • Partial Differential Equations Elective Applied courses: These are the courses from other majors that emphasize the applications of Mathematics.  Students will have to take at least 2 applied courses (at least one at 200 level). If there is any prerequisite, students need to either complete the course’s prerequisites or obtain the instructor’s approval. Sample Applied Courses Sample Economics Courses • Game theory • The Economics of Corruption • Money and Banking • Economics of Inequality • Economics of Education • Cost-Benefit Analysis • Market design Sample Engineering Courses: • Signal, Systems, and Control • Computer Vision Sample Computer Science Courses • Introduction to Machine Learning • Algorithm • Statistical learning • Introduction to AI Sample Applied Mathematics Courses • Operations Research • Introduction to Quantitative Finance Note: Students may not double count a course for two different requirements. For example, Operations research can only count for either 1 Advanced
    ...
    ### Response
    Yes, Discrete Mathematics can be counted for both Computer Science and Applied Mathematics majors, but students cannot double count it for two different requirements. For instance, Operations Research can only count for either 1 Advanced requirement in Computer Science or Applied Mathematics. Therefore, Discrete Mathematics can be used towards fulfilling the Computer Science minor requirement but not for the Applied Mathematics elective requirement simultaneously.
...
(Introductory) • Computer Science 2 (Intermediate). Sample Mathematics Courses • Calculus • Linear Algebra • Discrete Maths • Introduction to Data Analysis • Probability and Statistics • Multivariate Calculus Sample Basic Science Courses • Introductory Biology • Energy in Daily Life • Matter • Biology of Infectious Diseases • Organic Chemistry • Physics for Light-based Technology • Materials that Shape Out Our World. Requirements for Declaring the Engineering Major and Minor To formally declare Engineering as your major, you must complete core course Design and Systems Thinking, one Programming Foundation course, two Mathematics or Basic Science courses, and two Engineering Foundation/Intermediate courses. To formally declare the Engineering minor, you must complete core course Design and Systems Thinking, one Programming Foundation course, one Mathematics or Basic Science course, and one Engineering Foundation/Intermediate course. Graduation with Honors Requirements • Student must complete Capstone I and
    ...
    ### Response
    The requirements for mathematics courses to pursue HCE major include completing at least 3 Foundation courses and 1 Intermediate course. Additionally, students need to meet specific prerequisites or obtain the instructor's approval for certain courses. They are also required to take at least 1 Pure mathematics course and consult with an academic advisor for course selection. Furthermore, students need to complete Capstone I and II, along with Introductory and Intermediate Computer Science courses. The exact courses may vary depending on the institution. Therefore, it is recommended to check the specific requirements set by the respective university. However, this information is based on the provided context and may not be exhaustive. For accurate and up-to-date information, please refer to the official university website or contact the relevant academic department directly. 

Note: The original context does not explicitly mention HCE major, so this answer is inferred based on typical requirements for a mathematics major. If HCE stands for something specific, please provide additional details for more accurate information.
...
of areas with applications in Mathematics: • Applied Statistics (Economics, Social Sciences, Mathematical Finance, Bioinformatics…) • Engineering Mathematics (Signal processing, Numerical simulation, Inverse problems…) • Data Science (Machine learning, Artificial intelligence …) Students will take at least 2 advanced courses. Consultation with an academic advisor is required for course selection. Sample Advanced Courses • Advanced Statistics • Statistical Learning • Stochastic Calculus • Numerical Analysis • Optimization • Partial Differential Equations Elective Applied courses: These are the courses from other majors that emphasize the applications of Mathematics.  Students will have to take at least 2 applied courses (at least one at 200 level). If there is any prerequisite, students need to either complete the course’s prerequisites or obtain the instructor’s approval. Sample Applied Courses Sample Economics Courses • Game theory • The Economics of Corruption • Money and Banking • Economics of Inequality
    ...
    ### Response
    Yes, it is possible to graduate with double majors in HCE (Humanities, Communications, and Education) and Applied Mathematics. Below is a sample study plan that outlines the courses you might take to fulfill the requirements for both majors.
...
**Electives (Other Majors)**
- Choose two electives from another major that emphasize the applications of Mathematics. For example:
...
- It is highly recommended to consult with an academic advisor to ensure all courses meet the requirements for both majors and avoid double counting.

This plan provides a broad overview of the courses you would likely take to complete a double major in HCE and Applied Mathematics. The specific courses and sequence may vary depending on your institution's curriculum and the exact requirements for each major. Always consult with your academic advisor to tailor the plan to your specific situation.
